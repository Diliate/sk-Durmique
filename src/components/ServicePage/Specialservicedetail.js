...
function Specialservicedetail() {
  ...
  return (
    <div className="specialservicedetail-container">
      <div className="specialservice-inner-container">
